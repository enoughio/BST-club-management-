...
type Achievement = { id: string; title: string; date?: string; type?: string };
    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-gray-500">
          Welcome to your Storytellers member dashboard.
        </p>
      </div>
          ...
          <>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-gray-900">
                    {new Date(
                      memberData.membershipExpiryDate || "",
                    ).toLocaleDateString()}
                  </div>
                  <Badge
                    className={`mt-2 ${getMembershipStatus(memberData.membershipExpiryDate).color}`}
                  >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-gray-900">
                    {memberData.upcomingMeetings.length}
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    Next: {memberData.upcomingMeetings[0]?.date}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-gray-900">
                    {memberData.achievements.length}
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    Latest: {memberData.achievements[0]?.title}
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Your recent awards and accomplishments
                  </CardDescription>
                </CardHeader>
                <CardContent>
