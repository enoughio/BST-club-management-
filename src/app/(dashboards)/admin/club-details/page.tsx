        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              {isEditing ? <Input name="name" value={club?.name || ""} onChange={handleChange} /> : <p className="text-sm font-medium">{club?.name}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? <Textarea name="address" value={club?.address || ""} onChange={handleChange} /> : <p className="text-sm">{club?.address}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? <Input name="city" value={club?.city || ""} onChange={handleChange} /> : <p className="text-sm">{club?.city}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? <Input name="meetingTime" value={club?.meetingTime || ""} onChange={handleChange} /> : <p className="text-sm">{club?.meetingTime}</p>}
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              {isEditing ? <Input name="Admin" value={club?.Admin || ""} onChange={handleChange} /> : <p className="text-sm font-medium">{club?.Admin}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? <Input name="email" value={club?.email || ""} onChange={handleChange} /> : <p className="text-sm">{club?.email}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? <Input name="phone" value={club?.phone || ""} onChange={handleChange} /> : <p className="text-sm">{club?.phone}</p>}
            </div>
            ...
            <div className="space-y-2">
              ...
              {isEditing ? <Textarea name="description" value={club?.description || ""} onChange={handleChange} rows={5} /> : <p className="text-sm">{club?.description}</p>}
            </div>
          </CardContent>
        </Card>
              ...
              <div className="grid gap-4 grid-cols-2 mt-4">
                <div className="space-y-2">
                  ...
                  <Input
                    id="lat"
                    name="lat"
                    value={club?.position ? String(club.position[0]) : ""}
                    onChange={(e) => {
                      const lat = Number.parseFloat(e.target.value) || 0
                      setClub((prev) => ({ ...(prev || {}), position: [lat, prev?.position ? prev.position[1] : 0] }))
                    }}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    id="lng"
                    name="lng"
                    value={club?.position ? String(club.position[1]) : ""}
                    onChange={(e) => {
                      const lng = Number.parseFloat(e.target.value) || 0
                      setClub((prev) => ({ ...(prev || {}), position: [prev?.position ? prev.position[0] : 0, lng] }))
                    }}
                  />
                </div>
              </div>
