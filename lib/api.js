...
const mockMeetings = [
  {
    ...
    club: "1",
    roles: [
      { role: "Master Of Ceramonies", assignedTo: "1" },
      { role: "Open Mic Coordinator", assignedTo: "2" },
      { role: "Chief Evaluator", assignedTo: "3" },
      { role: "Timekeeper", assignedTo: null },
      { role: "Filler Counter", assignedTo: null },
      { role: "Listener", assignedTo: "2" },
      { role: "Language Evaluator", assignedTo: "1" },
      { role: "Speaker 1", assignedTo: "4" },
      { role: "Speaker 2", assignedTo: null },
      { role: "Speach Evaluator", assignedTo: null },
    ],
  },
  {
    id: "2",
    ...
    roles: [
      ...
      { role: "VP Program Quality", assignedTo: "2" },
      { role: "VP Club Grouth", assignedTo: "4" },
      { role: "VP Public Relation & Marketing", assignedTo: "4" },
      { role: "Club Secretary", assignedTo: null },
      { role: "Sergent at Arms", assignedTo: "4" },
    ],
  },
  {
    id: "3",
